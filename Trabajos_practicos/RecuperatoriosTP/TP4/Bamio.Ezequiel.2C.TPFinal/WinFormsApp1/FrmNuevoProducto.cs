...
namespace VistaForm
{
    public partial class FrmNuevoProducto : Form
    {
        ...
        private void btnNuevo_Click(object sender, EventArgs e)
        {
            ...
            int precio;
            if (txtNombre.Text != "" && txtPrecio.Text != "" && int.TryParse(txtPrecio.Text, out precio) && nudStock.Value > 0 && precio > 0)
            {
                try
                {
                    Producto producto = new Producto(txtNombre.Text, precio, tamanio, tipo, eProducto, (int)nudStock.Value);
                    Producto auxProducto = Producto.VerificarProducto(this.fabrica.Productos, producto);
            ...
            {
                MessageBox.Show("Hubo un error, vuelva a revisar los campos.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
